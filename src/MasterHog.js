    ...
    return (
      <div>
        ...
        <ul className="hoglist">
          <BabyHog color = {this.state.eyeColor} data={offspring[0]}/>
          <BabyHog color = {this.state.eyeColor} data={offspring[1]}/>
          <BabyHog color = {this.state.eyeColor} data={offspring[2]}/>
        </ul>
