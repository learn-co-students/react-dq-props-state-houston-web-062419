    ...
    return (
      <div>
        ...
        <ul className="hoglist">
          <BabyHog eyeColor={this.state.eyeColor} name={offspring[0].name} hobby={offspring[0].hobby} weight={this.state.weight}/>
          <BabyHog eyeColor={this.state.eyeColor} name={offspring[1].name} hobby={offspring[1].hobby} weight={this.state.weight}/>
          <BabyHog eyeColor={this.state.eyeColor} name={offspring[2].name} hobby={offspring[2].hobby} weight={this.state.weight}/>
        </ul>
